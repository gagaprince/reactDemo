...
/***/ function(module, exports, __webpack_require__) {
	...
	var BtnGroup = __webpack_require__(157);

	var SimpleBtn = __webpack_require__(158);

	var LabelText = __webpack_require__(159);
	        ...
	        var btns = this.props.data.map(function (btnItem) {
	            ...
	            switch (btnItem.type){
	                case "simple":
	                    ...
	                    html = React.createElement(SimpleBtn, {onclick: btnItem.click, btnName: btnItem.btnName})
	                    break;
	                case "big":
	                    html = React.createElement("div", null, btnItem.btnName)
	                    break;
	            }
	            return (
	                html
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SimpleBtn= React.createClass({displayName: "SimpleBtn",
	    ...
	    render:function(){
	        return (
	            React.createElement("div", {className: "btn", onClick: this.handleClick}, 
	                this.props.btnName
	            )
	            )
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LabelText = React.createClass({displayName: "LabelText",
	    getInitialState:function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TextGroup = React.createClass({displayName: "TextGroup",
	    ...
	    render:function(){
	        ...
	        return (
	            React.createElement("div", null, texts)
	            )
	    }
	});
